...
var CEL_FIELD_MAPPINGS = MethodFieldMappings{
	...
	"subscribePredictionEventActivities": {
		...
		"pricePerShare":          "a.pps",
		"amountInUsd":            "a.aiu",
		"collateralAmount":       "a.ca",
		"collateralAmountInUsd":  "a.cau",
		"collateralTokenSymbol":  "a.cs",
		"collateralTokenAddress": "a.cad",
		"counterparty":           "a.cp",
		"feeAmount":              "a.fa",
		"feeAmountInUsd":         "a.fau",
		"feePayer":               "a.fp",
		"feeRecipient":           "a.fr",
		"economicOutcome":        "a.eo",
		"economicAmount":         "a.ea",
		"economicAmountInUsd":    "a.eau",
		"rawAmount":              "a.ra",
		"economicTokenId":        "a.etid",
		"economicPrice":          "a.ep",
		"feeTokenSymbol":         "a.fs",
		"feeTokenAddress":        "a.fad",
	},
