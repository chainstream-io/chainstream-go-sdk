...
func parsePredictionActivity(root map[string]interface{}) PredictionActivity {
	...
	return PredictionActivity{
		...
		AmountInUsd:            getString(dataMap, "aiu"),
		AssetIDs:               getStringSlice(dataMap, "as"),
		BlockNumber:            getInt64(dataMap, "bn"),
		CollateralAmount:       getString(dataMap, "ca"),
		CollateralAmountInUsd:  getString(dataMap, "cau"),
		CollateralTokenAddress: getString(dataMap, "cad"),
		CollateralTokenSymbol:  getString(dataMap, "cs"),
		ConditionID:            getString(dataMap, "cid"),
		Counterparty:           getString(dataMap, "cp"),
		EconomicAmount:         getString(dataMap, "ea"),
		EconomicAmountInUsd:    getString(dataMap, "eau"),
		EconomicOutcome:        getString(dataMap, "eo"),
		EconomicPrice:          getString(dataMap, "ep"),
		EconomicTokenID:        getString(dataMap, "etid"),
		EventSlug:              getString(dataMap, "es"),
		FeeAmount:              getString(dataMap, "fa"),
		FeeAmountInUsd:         getString(dataMap, "fau"),
		FeePayer:               getString(dataMap, "fp"),
		FeeRecipient:           getString(dataMap, "fr"),
		FeeTokenAddress:        getString(dataMap, "fad"),
		FeeTokenSymbol:         getString(dataMap, "fs"),
		...
		ParticipantRole:        PredictionParticipantRole(getString(dataMap, "rl")),
		Price:                  getString(dataMap, "p"),
		PricePerShare:          getString(dataMap, "pps"),
		Quantity:               getString(dataMap, "q"),
		RawAmount:              getString(dataMap, "ra"),
		RawOutcome:             getString(dataMap, "ro"),
		RawPrice:               getString(dataMap, "rp"),
		RawTokenID:             getString(dataMap, "rtid"),
		RawType:                getString(dataMap, "rt"),
		SeqIndex:               seqIndex,
