...
// Defines values for RankingPoolType.
const (

  NewPool RankingPoolType = "new-pool"
)

// Valid indicates whether the value is a known member of the RankingPoolType enum.
func (e RankingPoolType) Valid() bool {
    switch e {
    case NewPool:
        return true
    default:
...
const (
  ...
  RankingTagBonkFun RankingTag = "bonk_fun"
  RankingTagMeteoraDynamicBoundingCurve RankingTag = "meteora_dynamic_bounding_curve"
  RankingTagMoonitFun RankingTag = "moonit_fun"
  RankingTagPumpFun RankingTag = "pump_fun"
  RankingTagRaydiumLaunchpad RankingTag = "raydium_launchpad"
)

// Valid indicates whether the value is a known member of the RankingTag enum.
func (e RankingTag) Valid() bool {
    switch e {
    case RankingTagBonkFun:
        return true
    case RankingTagMeteoraDynamicBoundingCurve:
        return true
    case RankingTagMoonitFun:
        return true
    case RankingTagPumpFun:
        return true
    case RankingTagRaydiumLaunchpad:
        return true
    default:
        return false
    }
...
// DexPoolBalance defines model for DexPoolBalance.
...
// RankingPool defines model for RankingPool.
type RankingPool  struct {
    Balance *DexPoolBalance`json:"balance,omitempty"`
...
// RankingPoolType defines model for RankingPoolType.
type RankingPoolType  string
...
// GetRankingPoolsParams defines parameters for GetRankingPools.
type GetRankingPoolsParams  struct {
// Tag DTO.RANKING.TAG
...
// GetRankingPools request
    GetRankingPools(ctx context.Context, chain ChainSymbol, rankingType RankingPoolType, params *GetRankingPoolsParams, reqEditors... RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetRankingPools(ctx context.Context, chain ChainSymbol, rankingType RankingPoolType, params *GetRankingPoolsParams, reqEditors... RequestEditorFn) (*http.Response, error) {
    req, err := NewGetRankingPoolsRequest(c.Server, chain, rankingType, params)
    if err != nil {
        return nil, err
    }
...
// NewGetRankingPoolsRequest generates requests for GetRankingPools
func NewGetRankingPoolsRequest(server string, chain ChainSymbol, rankingType RankingPoolType, params *GetRankingPoolsParams) (*http.Request, error) {
    var err error
    ...
    pathParam1, err = runtime.StyleParamWithOptions("simple", false, "rankingType", rankingType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
    if err != nil {
        return nil, err
    }
    ...
    operationPath := fmt.Sprintf("/v2/ranking-pools/%s/%s", pathParam0, pathParam1)
    if operationPath[0] == '/' {
...
// GetRankingPoolsWithResponse request
    GetRankingPoolsWithResponse(ctx context.Context, chain ChainSymbol, rankingType RankingPoolType, params *GetRankingPoolsParams, reqEditors... RequestEditorFn) (*GetRankingPoolsResponse, error)
...
type GetRankingPoolsResponse struct {
    Body         []byte
...
func (r GetRankingPoolsResponse) Status() string {
...
func (r GetRankingPoolsResponse) StatusCode() int {
    if r.HTTPResponse != nil {
...
func (r GetRankingPoolsResponse) ContentType() string {
    if r.HTTPResponse != nil {
...
// GetRankingPoolsWithResponse request returning *GetRankingPoolsResponse
func (c *ClientWithResponses) GetRankingPoolsWithResponse(ctx context.Context, chain ChainSymbol, rankingType RankingPoolType, params *GetRankingPoolsParams, reqEditors... RequestEditorFn) (*GetRankingPoolsResponse, error){
    rsp, err := c.GetRankingPools(ctx, chain, rankingType, params, reqEditors...)
    if err != nil {
        return nil, err
    }
    return ParseGetRankingPoolsResponse(rsp)
}
...
// ParseGetRankingPoolsResponse parses an HTTP response from a GetRankingPoolsWithResponse call
func ParseGetRankingPoolsResponse(rsp *http.Response) (*GetRankingPoolsResponse, error) {
    ...
    response := &GetRankingPoolsResponse{
Body: bodyBytes,
HTTPResponse: rsp,
}
