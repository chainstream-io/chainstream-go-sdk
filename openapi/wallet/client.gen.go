...
func (e PnlResolution) Valid() bool {
    switch e {
    case PnlResolutionAll:
        return true
    case PnlResolutionN1d:
        return true
    case PnlResolutionN30d:
        return true
    case PnlResolutionN7d:
        return true
    default:
        return false
    }
...
// Defines values for PnlSortBy.
const (

  RealizedPnl PnlSortBy = "realizedPnl"
  TotalPnl PnlSortBy = "totalPnl"
  UnrealizedPnl PnlSortBy = "unrealizedPnl"
)

// Valid indicates whether the value is a known member of the PnlSortBy enum.
func (e PnlSortBy) Valid() bool {
    switch e {
    case RealizedPnl:
        return true
    case TotalPnl:
...
// Defines values for PositionState.
const (

  PositionStateAll PositionState = "all"
  PositionStateClosed PositionState = "closed"
  PositionStateOpen PositionState = "open"
)

// Valid indicates whether the value is a known member of the PositionState enum.
func (e PositionState) Valid() bool {
    switch e {
    case PositionStateAll:
        return true
...
// PnlSortBy Sort field for PnL details query
type PnlSortBy  string

// PositionState Filter for PnL position state
...
// PositionState DTO.WALLET.PNL_DETAILS.POSITION_STATE
    PositionState *PositionState`form:"positionState,omitempty" json:"positionState,omitempty"`

// SortBy DTO.WALLET.PNL_DETAILS.SORT_BY
    SortBy *PnlSortBy`form:"sortBy,omitempty" json:"sortBy,omitempty"`
}
    ...
    if params != nil {
        ...
        var rawQueryFragments []string
            ...
            if queryFrag, err := runtime.StyleParamWithOptions("form", true, "resolution", params.Resolution, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
             ...
             if params.PositionState != nil { 
            
            
            
            if queryFrag, err := runtime.StyleParamWithOptions("form", true, "positionState", *params.PositionState, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
                return nil, err
            } else {
                for _, qp := range strings.Split(queryFrag, "&") {
                    rawQueryFragments = append(rawQueryFragments, qp)
