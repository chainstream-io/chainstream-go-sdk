...
const (
  ...
  Ascending EndpointOrder = "ascending"
  Descending EndpointOrder = "descending"
)

// Valid indicates whether the value is a known member of the EndpointOrder enum.
func (e EndpointOrder) Valid() bool {
    switch e {
    case Ascending:
        return true
    case Descending:
...
// Defines values for WebhookChannel.
const (

  SolTokenCreated WebhookChannel = "sol.token.created"
  SolTokenMigrated WebhookChannel = "sol.token.migrated"
)

// Valid indicates whether the value is a known member of the WebhookChannel enum.
func (e WebhookChannel) Valid() bool {
    switch e {
    case SolTokenCreated:
        return true
    case SolTokenMigrated:
        return true
    default:
        return false
    }
...
// EndpointOrder Ordering direction for paginated endpoint listing
type EndpointOrder  string
...
// WebhookChannel Webhook event channel
...
type UpdateEndpointJSONRequestBody = UpdateWebhookRequest
...
type CreateEndpointJSONRequestBody = CreateWebhookRequest
...
func NewListEndpointsRequest(server string, params *ListEndpointsParams) (*http.Request, error) {
    ...
    operationPath := fmt.Sprintf("/v2/webhook/endpoint")
    if operationPath[0] == '/' {
...
func NewDeleteEndpointRequest(server string, id string) (*http.Request, error) {
    ...
    operationPath := fmt.Sprintf("/v2/webhook/endpoint/%s", pathParam0)
    if operationPath[0] == '/' {
        operationPath = "." + operationPath
    }
...
func NewGetEndpointSecretRequest(server string, id string) (*http.Request, error) {
    ...
    operationPath := fmt.Sprintf("/v2/webhook/endpoint/%s/secret", pathParam0)
    if operationPath[0] == '/' {
        operationPath = "." + operationPath
    }
...
func NewRotateEndpointSecretRequest(server string, id string) (*http.Request, error) {
    ...
    operationPath := fmt.Sprintf("/v2/webhook/endpoint/%s/secret/rotate", pathParam0)
    if operationPath[0] == '/' {
        operationPath = "." + operationPath
    }
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetEndpointSecretResponse) ContentType() string {
    if r.HTTPResponse != nil {
        return r.HTTPResponse.Header.Get("Content-Type")
    }
    return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r RotateEndpointSecretResponse) ContentType() string {
    if r.HTTPResponse != nil {
        return r.HTTPResponse.Header.Get("Content-Type")
    }
    return ""
