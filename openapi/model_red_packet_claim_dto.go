...
func NewRedPacketClaimDTO(packetId string, chain string, claimer string, mint string, amount string, claimedAt float32, creator string, txHash string) *RedPacketClaimDTO {
...
func (o *RedPacketClaimDTO) GetChain() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RedPacketClaimDTO) GetChainOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Chain, true
...
func (o *RedPacketClaimDTO) SetChain(v string) {
	o.Chain = v
}
