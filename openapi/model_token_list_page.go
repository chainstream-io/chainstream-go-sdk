...
// checks if the TokenListPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenListPage{}

// TokenListPage struct for TokenListPage
...
type _TokenListPage TokenListPage
...
func (o TokenListPage) MarshalJSON() ([]byte, error) {
...
func (o TokenListPage) ToMap() (map[string]interface{}, error) {
...
func (o *TokenListPage) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenListPage := _TokenListPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenListPage)

	if err != nil {
		return err
	}

	*o = TokenListPage(varTokenListPage)

	return err
}

type NullableTokenListPage struct {
	value *TokenListPage
	isSet bool
}

func (v NullableTokenListPage) Get() *TokenListPage {
	return v.value
}

func (v *NullableTokenListPage) Set(val *TokenListPage) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenListPage) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenListPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenListPage(val *TokenListPage) *NullableTokenListPage {
	return &NullableTokenListPage{value: val, isSet: true}
}

func (v NullableTokenListPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenListPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
