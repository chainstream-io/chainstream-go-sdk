...
[**GetKytAddresses**](KYTAPI.md#GetKytAddresses) | **Get** /v1/kyt/addresses | CONTROLLER.KYT.GET_KYT_ADDRESSES.SUMMARY
[**GetKytTransfers**](KYTAPI.md#GetKytTransfers) | **Get** /v1/kyt/transfers | CONTROLLER.KYT.GET_KYT_TRANSFERS.SUMMARY
[**GetKytWithdrawals**](KYTAPI.md#GetKytWithdrawals) | **Get** /v1/kyt/withdrawals | CONTROLLER.KYT.GET_KYT_WITHDRAWALS.SUMMARY
...
> KytAddressPage GetKytAddresses(ctx).Page(page).PageSize(pageSize).Execute()
...
func main() {
	page := float32(8.14) // float32 | DTO.KYT.STANDARD_PAGING_QUERY.PAGE (optional) (default to 1)
	pageSize := float32(8.14) // float32 | DTO.KYT.STANDARD_PAGING_QUERY.PAGE_SIZE (optional) (default to 20)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KYTAPI.GetKytAddresses(context.Background()).Page(page).PageSize(pageSize).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KYTAPI.GetKytAddresses``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetKytAddresses`: KytAddressPage
	fmt.Fprintf(os.Stdout, "Response from `KYTAPI.GetKytAddresses`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetKytAddressesRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **page** | **float32** | DTO.KYT.STANDARD_PAGING_QUERY.PAGE | [default to 1]
 **pageSize** | **float32** | DTO.KYT.STANDARD_PAGING_QUERY.PAGE_SIZE | [default to 20]

### Return type

[**KytAddressPage**](KytAddressPage.md)
...
> KytTransferPage GetKytTransfers(ctx).Page(page).PageSize(pageSize).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KYTAPI.GetKytTransfers(context.Background()).Page(page).PageSize(pageSize).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KYTAPI.GetKytTransfers``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetKytTransfers`: KytTransferPage
	fmt.Fprintf(os.Stdout, "Response from `KYTAPI.GetKytTransfers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetKytTransfersRequest struct via the builder pattern
...
[**KytTransferPage**](KytTransferPage.md)
...
> KytWithdrawalPage GetKytWithdrawals(ctx).Page(page).PageSize(pageSize).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KYTAPI.GetKytWithdrawals(context.Background()).Page(page).PageSize(pageSize).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KYTAPI.GetKytWithdrawals``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetKytWithdrawals`: KytWithdrawalPage
	fmt.Fprintf(os.Stdout, "Response from `KYTAPI.GetKytWithdrawals`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetKytWithdrawalsRequest struct via the builder pattern
...
[**KytWithdrawalPage**](KytWithdrawalPage.md)
