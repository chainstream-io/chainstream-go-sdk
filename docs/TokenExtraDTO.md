...
------------ | ------------- | ------------- | -------------
**CollectionAddress** | Pointer to **string** | The unique identification address of an NFT Collection | [optional] 
**EditionNonce** | Pointer to **int64** | Version number, used to identify the version or serial number of an NFT | [optional] 
**Fungible** | Pointer to **bool** | Whether it is a convertible token: If true, it indicates that the token is convertible (such as SPL tokens, like USDC or SOL).If false, it indicates that the token is non-interchangeable (such as NFTS, each token has unique metadata) | [optional] 
**IsMutable** | Pointer to **bool** | Indicates whether the metadata of the token can be changed | [optional] 
**Key** | Pointer to **string** | The key type of a token indicates the type or role of the token.Common values include:Mint: Indicates the minting account of the token;Metadata: Represents a Metaplex metadata account;MasterEdition: Indicates the main version of the NFT;Edition: Indicates a limited edition copy. | [optional] 
**IsNative** | Pointer to **bool** | Indicates whether the token is native token | [optional] 
**PrimarySaleHappened** | Pointer to **bool** | Indicates whether the NFT has completed its first sale | [optional] 
**LaunchFromProgramAddress** | Pointer to **string** | External program address (the address that drives program_address) | [optional] 
**LaunchFromProtocolFamily** | Pointer to **string** | Initialized Protocol family | [optional] 
**ProgramAddress** | Pointer to **string** | Program address | [optional] 
**MigratedToProgramAddress** | Pointer to **string** | Address of the migrated program after token migration | [optional] 
**MigratedToProtocolFamily** | Pointer to **string** | The Protocol family migrated | [optional] 
**MigratedToPoolAddress** | Pointer to **string** | Address of the migrated liquidity pool after token migration | [optional] 
**MigratedAt** | Pointer to **int64** | Timestamp when the token migration occurred (in milliseconds) | [optional] 
**SellerFeeBasisPoints** | Pointer to **int64** | The seller&#39;s fee basis point indicates the royalty ratio of the creator at the time of secondary sales (in basis points, 1% &#x3D; 100 basis points) | [optional] 
**TokenStandard** | Pointer to **string** | The standard type of token describes the protocol or specification that the token follows | [optional] 
**MintAuthority** | Pointer to **string** | Mint authority address | [optional] 
**FreezeAuthority** | Pointer to **string** | Freeze authority address | [optional] 
**UpdateAuthority** | Pointer to **string** | Update authority address | [optional] 
**IsVerifiedCollection** | Pointer to **bool** | Indicates whether the NFT belongs to a verified collection | [optional] 
**IsWrapped** | Pointer to **bool** | Indicates whether the Token is a Wrapped token (Wrapped Token) | [optional] 
